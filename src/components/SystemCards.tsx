...
const items: CardItem[] = [
  {
    ...
    route: "/systems/wa-ha",
    description:
      "Compute tropical or sidereal planetary positions with selectable house system and persist outputs.",
  },
  {
    system: "JA",
  ...
  },
  {
    ...
    route: "/systems/bazi",
    description:
      "Four Pillars and Luck Pillars generated from the configured Chinese calendar provider.",
  },
  {
    system: "ZWDS",
    title: "Zi Wei Dou Shu",
    route: "/systems/zwds",
    description: "12-palace chart view populated by the configured Zi Wei Dou Shu provider.",
  },
  {
    system: "QMDJ",
    ...
    route: "/systems/qmdj",
    description:
      "3×3 Lo Shu board with school selector and hour/day toggle generated by the configured provider.",
  },
  {
    system: "FS",
    title: "Feng Shui",
    route: "/systems/fs",
    description:
      "Flying Star matrix and Eight Mansions calculator with dataset logging for computed guidance.",
  },
  {
    system: "HD",
    title: "Human Design",
    route: "/systems/hd",
    description:
      "BodyGraph centres, type, and authority computed via the configured Human Design provider.",
  },
  {
    system: "GK",
    title: "Gene Keys",
    route: "/systems/gk",
    description:
      "Hologenetic profile spheres generated through the configured Gene Keys provider.",
  },
  {
    system: "IChing",
    title: "I Ching",
